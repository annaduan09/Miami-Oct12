...
ggplot() +
  ...
  scale_fill_manual(values = palette5) +
 labs(title = "Parks", subtitle = "Miami, FL") +
  mapTheme()

ggplot() +
  geom_sf(data = acs, aes(fill = q5(timeToWork))) +
  geom_sf(data = housesKnown, aes(colour = q5(busStops))) +
  scale_fill_manual(values = palette5) +
   labs(title = "Bus Stops within Buffer and Travel Time to Work", subtitle = "Miami, FL") +
  mapTheme()
